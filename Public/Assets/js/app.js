var AppProcess = (function () {
  ...
  function removeMediaSenders(rtp_senders) {
    console.log("removeMediaSenders rtp_senders :", rtp_senders);
    for (var con_id in peers_connection_ids) {
  ...
  function removeVideoStream(rtp_vid_senders) {
    console.log("removeVideoStream rtp_vid_senders :", rtp_vid_senders);
    if (videoCamTrack) {
      videoCamTrack.stop();
      videoCamTrack = null;
...
var MyApp = (function () {
  ...
  function event_process_for_signaling_server() {
    ...
    socket.on("showChatMessage", function (data) {
      var time = new Date();
      var lTime = time.toLocaleTimeString("en-US", {
        hour: "numeric",
        minute: "numeric",
        hour12: true,
      });
